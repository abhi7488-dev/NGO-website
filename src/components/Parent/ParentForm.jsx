...
const ParentForm = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 min-h-[calc(100vh-84px)]">
        <section className="max-w-7xl mx-auto px-4 py-10 flex flex-col gap-5">
        <h1 className="text-blue-400 text-[24px]">Step 1: Set Up Your Family Information</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="p-4 rounded">
          <h2 className="text-xl font-bold mb-4">2nd PARENT (If Applicable)</h2>

          <div>
            <label className="block mb-1 font-medium">
              Would you like to invite this person to manage account with you?
            </label>
            <select
              name="secondInvite"
              value={formData.secondInvite}
              onChange={handleChange}
              className="w-[200px] bg-white border p-1 rounded"
            >
              <option>No</option>
