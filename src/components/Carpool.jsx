...
const SportsBuddy = () => {
  ...
  const handleFindMatches = () => {
    // Logic to find matches based on selected sport
    const matches = filteredPlayers.map((player) => player.name);
    ...
    <div className="min-h-screen bg-gry-200 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-400 mb-3">
            🎮 Sports Buddy Finder
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Connect with sports enthusiasts near you. Find your perfect match
            for basketball, football, cricket and more!
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 flex flex-col">
            ...
            <div className="h-80 w-full overflow-hidden relative z-0">
              <MapContainer
            ...
            {chatPlayer ? (
              <div className="border-t border-gray-200 p-4 h-80 flex flex-col">
                <div className="flex items-center mb-4">
                  <img
                    src={chatPlayer.image}
                    alt={chatPlayer.name}
                    className="w-10 h-10 rounded-full object-cover mr-3"
                  />
                  <div>
                    <h3 className="font-semibold text-gray-800">
                      Chat with {chatPlayer.name}
                    </h3>
                    <div className="flex items-center text-sm text-gray-500">
                      <span className="flex items-center">
                        <span className="mr-1">
                          {sportIcons[chatPlayer.sport]}
                        </span>
                        {chatPlayer.sport}
                      </span>
